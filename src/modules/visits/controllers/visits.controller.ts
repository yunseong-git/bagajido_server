...
export class VisitsController {
    ...
    getMyVisits(
        ...
        @Query() dto: GetMyVisitsDto,
    ) {
        return this.visitsQueryService.getMyVisits(
            user.id,
            dto,
        );
    }
    ...
    getMyVisit(
        ...
        return this.visitsQueryService.getMyVisit(
            user.id,
            visitId,
        );
    }
    ...
    updateVisit(
        ...
        return this.visitsCommandService.updateVisit(
            user.id,
            visitId,
            dto,
        );
